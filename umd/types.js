(function (factory) {
    ...
    class XsdString extends common_1.XsdAnySimpleType {
    ...
    exports.XsdString = XsdString;
    class XsdNormalizedString extends XsdString {
        constructor(tsType = null, nativeName = null) {
    ...
    exports.XsdNormalizedString = XsdNormalizedString;
    class XsdToken extends XsdNormalizedString {
        constructor(tsType = null, nativeName = null) {
    ...
    exports.XsdToken = XsdToken;
    const languagePattern = /^[a-zA-Z]{1,8}(?:-[a-zA-Z0-9]{1,8})*$/;
    class XsdLanguage extends XsdToken {
        constructor(tsType = null, nativeName = null) {
    ...
    exports.XsdLanguage = XsdLanguage;
    // tslint:disable-next-line:variable-name
    const NMTOKENPattern = /^[a-zA-Z0-9_:\-\.]+$/;
    class XsdNMTOKEN extends XsdToken {
        constructor(tsType = null, nativeName = null) {
    ...
    exports.XsdNMTOKEN = XsdNMTOKEN;
    // tslint:disable-next-line:variable-name
    const NMTOKENSPattern = /^[a-zA-Z0-9_:\-\.]+(?: [a-zA-Z0-9_:\-\.]+)*$/;
    // TODO: XsdList
    class XsdNMTOKENS extends XsdToken {
        constructor(tsType = null, nativeName = null) {
    ...
    exports.XsdNMTOKENS = XsdNMTOKENS;
    const namePattern = /^[a-zA-Z_:][a-zA-Z0-9_:\-\.]*$/;
    class XsdName extends XsdToken {
        constructor(tsType = null, nativeName = null) {
    ...
    exports.XsdName = XsdName;
    class XsdNCName extends XsdName {
        constructor(tsType = null, nativeName = null) {
    ...
    exports.XsdNCName = XsdNCName;
    class XsdID extends XsdNCName {
        constructor(tsType = null, nativeName = null) {
            super(tsType || ["string"], nativeName || "ID");
        }
    }
    exports.XsdID = XsdID;
    class XsdIDREF extends XsdNCName {
        constructor(tsType = null, nativeName = null) {
            super(tsType || ["string"], nativeName || "IDREF");
        }
    }
    exports.XsdIDREF = XsdIDREF;
    const idrefsPattern = /^[a-zA-Z_:][a-zA-Z0-9_:\-\.]*(?: [a-zA-Z_:][a-zA-Z0-9_:\-\.]*)*$/;
    // TODO: XsdList
    class XsdIDREFS extends XsdIDREF {
        constructor(tsType = null, nativeName = null) {
    ...
    exports.XsdIDREFS = XsdIDREFS;
    class XsdENTITY extends XsdNCName {
        constructor(tsType = null, nativeName = null) {
            super(tsType || ["string"], nativeName || "ENTITY");
        }
    }
    exports.XsdENTITY = XsdENTITY;
    const entitiesPattern = idrefsPattern;
    // TODO: XsdList
    class XsdENTITIES extends XsdIDREF {
        constructor(tsType = null, nativeName = null) {
    ...
    exports.XsdENTITIES = XsdENTITIES;
    const decimalPattern = /^[-\+]?(?:[0-9]+(?:\.[0-9]*)?|\.[0-9]+)$/;
    class XsdDecimal extends common_1.XsdAnySimpleType {
        constructor(tsType = null, nativeName = null) {
    ...
    exports.XsdDecimal = XsdDecimal;
    const integerPattern = /^[-\+]?[0-9]+$/;
    class XsdInteger extends XsdDecimal {
        constructor(tsType = null, nativeName = null) {
    ...
    exports.XsdInteger = XsdInteger;
    class XsdNonPositiveInteger extends XsdDecimal {
        constructor(tsType = null, nativeName = null) {
    ...
    exports.XsdNonPositiveInteger = XsdNonPositiveInteger;
    class XsdNegativeInteger extends XsdNonPositiveInteger {
        constructor(tsType = null, nativeName = null) {
    ...
    exports.XsdNegativeInteger = XsdNegativeInteger;
    ...
    class XsdLong extends XsdDecimal {
        constructor(tsType = null, nativeName = null) {
    ...
    exports.XsdLong = XsdLong;
    class XsdInt extends XsdLong {
        constructor(tsType = null, nativeName = null) {
    ...
    exports.XsdInt = XsdInt;
    class XsdShort extends XsdInt {
        constructor(tsType = null, nativeName = null) {
    ...
    exports.XsdShort = XsdShort;
    class XsdByte extends XsdShort {
        constructor(tsType = null, nativeName = null) {
    ...
    exports.XsdByte = XsdByte;
    class XsdNonNegativeInteger extends XsdDecimal {
        constructor(tsType = null, nativeName = null) {
    ...
    exports.XsdNonNegativeInteger = XsdNonNegativeInteger;
    class XsdPositiveInteger extends XsdNonNegativeInteger {
        constructor(tsType = null, nativeName = null) {
    ...
    exports.XsdPositiveInteger = XsdPositiveInteger;
    const unsignedLongMax = Math.min(18446744073709551615, Number.MAX_SAFE_INTEGER);
    class XsdUnsignedLong extends XsdNonNegativeInteger {
        constructor(tsType = null, nativeName = null) {
    ...
    exports.XsdUnsignedLong = XsdUnsignedLong;
    class XsdUnsignedInt extends XsdUnsignedLong {
        constructor(tsType = null, nativeName = null) {
    ...
    exports.XsdUnsignedInt = XsdUnsignedInt;
    class XsdUnsignedShort extends XsdUnsignedInt {
        constructor(tsType = null, nativeName = null) {
    ...
    exports.XsdUnsignedShort = XsdUnsignedShort;
    class XsdUnsignedByte extends XsdUnsignedShort {
        constructor(tsType = null, nativeName = null) {
    ...
    exports.XsdUnsignedByte = XsdUnsignedByte;
    const doublePattern = /^[-\+]?(?:([0-9]+(?:\.[0-9]*)?|\.[0-9]+)(?:[eE][0-9]+)?|INF|NaN)$/;
    class XsdFloat extends common_1.XsdAnySimpleType {
        constructor(tsType = null, nativeName = null) {
    ...
    exports.XsdFloat = XsdFloat;
    class XsdDouble extends common_1.XsdAnySimpleType {
        constructor(tsType = null, nativeName = null) {
    ...
    exports.XsdDouble = XsdDouble;
    class XsdNOTATION extends common_1.XsdAnySimpleType {
        constructor(tsType = null, nativeName = null) {
    ...
    exports.XsdNOTATION = XsdNOTATION;
    class XsdQName extends common_1.XsdAnySimpleType {
        constructor(tsType = null, nativeName = null) {
    ...
    exports.XsdQName = XsdQName;
    class XsdBoolean extends common_1.XsdAnySimpleType {
        constructor(tsType = null, nativeName = null) {
    ...
    class XsdBase64Binary extends common_1.XsdAnySimpleType {
        constructor(tsType = null, nativeName = null) {
    ...
    exports.XsdBase64Binary = XsdBase64Binary;
    class XsdHexBinary extends common_1.XsdAnySimpleType {
        constructor(tsType = null, nativeName = null) {
    ...
    exports.XsdHexBinary = XsdHexBinary;
    class XsdAnyURI extends common_1.XsdAnySimpleType {
        constructor(tsType = null, nativeName = null) {
    ...
    exports.XsdAnyURI = XsdAnyURI;
    const datePattern = /^-?[0-9]{4,}-[01][0-9]-[0-3][0-9](?:Z|[\+\-][0-2][0-9]:[0-6][0-9])?$/;
    class XsdDate extends common_1.XsdAnySimpleType {
        constructor(tsType = null, nativeName = null) {
    ...
    class XsdTime extends common_1.XsdAnySimpleType {
        constructor(tsType = null, nativeName = null) {
    ...
    exports.XsdDateTime = XsdDateTime;
    const gYearPattern = /^-?[0-9]{4,}(?:Z|[+\-][0-2][0-9]:[0-6][0-9])?$/;
    class XsdGYear extends common_1.XsdAnySimpleType {
        constructor(tsType = null, nativeName = null) {
    ...
    exports.XsdGYear = XsdGYear;
    const gYearMonthPattern = /^-?[0-9]{4,}-[0-1][0-9](?:Z|[+\-][0-2][0-9]:[0-6][0-9])?$/;
    class XsdGYearMonth extends common_1.XsdAnySimpleType {
        constructor(tsType = null, nativeName = null) {
    ...
    exports.XsdGYearMonth = XsdGYearMonth;
    const gMonthPattern = /^--[0-1][0-9](?:Z|[+\-][0-2][0-9]:[0-6][0-9])?$/;
    class XsdGMonth extends common_1.XsdAnySimpleType {
        constructor(tsType = null, nativeName = null) {
    ...
    exports.XsdGMonth = XsdGMonth;
    const gMonthDayPattern = /^--[0-1][0-9]-[01][0-9](?:Z|[+\-][0-2][0-9]:[0-6][0-9])?$/;
    class XsdGMonthDay extends common_1.XsdAnySimpleType {
        constructor(tsType = null, nativeName = null) {
    ...
    exports.XsdGMonthDay = XsdGMonthDay;
    const gDayPattern = /^---[0-3][0-9](?:Z|[+\-][0-2][0-9]:[0-6][0-9])?$/;
    class XsdGDay extends common_1.XsdAnySimpleType {
        constructor(tsType = null, nativeName = null) {
    ...
    exports.XsdGDay = XsdGDay;
    const durationPattern = /^-?P(?:[0-9]+Y)?(?:[0-9]{4,}M)?(?:[0-9]+D)?(?:T(?:[0-9]+H)?(?:[0-9]+M)?(?:[0-9]+(?:\.[0-9]+)?S)?)?$/;
    class XsdDuration extends common_1.XsdAnySimpleType {
        constructor(tsType = null, nativeName = null) {
    ...
    class XsdDayTimeDuration extends XsdDuration {
        constructor(tsType = null, nativeName = null) {
    ...
    exports.XsdDayTimeDuration = XsdDayTimeDuration;
    const yearMonthDurationPattern = /^-?P(?:[0-9]+Y)?(?:[0-9]{4,}M)?$/;
    class XsdYearMonthDuration extends XsdDuration {
        constructor(tsType = null, nativeName = null) {
    ...
    exports.XsdYearMonthDuration = XsdYearMonthDuration;
    var XsdNativeDataType;
    (function (XsdNativeDataType) {
        ...
        XsdNativeDataType.anySimpleType = registerType(new common_1.XsdAnySimpleType());
        // tslint:disable-next-line:variable-name
    ...
    })(XsdNativeDataType = exports.XsdNativeDataType || (exports.XsdNativeDataType = {}));
});
