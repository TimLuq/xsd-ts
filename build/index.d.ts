...
export { IBooleanFacets, IDateTimeFacets, IDateFacets, IDecimalFacets, IDoubleFacets, IDurationFacets, IEffectiveFacets, IFloatFacets, IStringFacets, ITimeFacets, XsdAny, XsdAnySimpleType, XsdComplexType, XsdElement, XsdExtension, XsdList, XsdRestriction, XsdSimpleType, XsdType, XsdUnion } from "./common";
...
export declare function parseDocument(docOrElem: Document | Element): Promise<IParserContext>;
export declare function ParserErrors(): Promise<typeof ParseError>;
